import { AvatarViewModel } from '../models/view-models';

export const AVATARS: AvatarViewModel[] = [
...
export const FALLBACK_AVATAR: AvatarViewModel = { id: 'default', emoji: '👤', background: '#e5e7eb' };

export function avatarById(id: string | null | undefined): AvatarViewModel {
